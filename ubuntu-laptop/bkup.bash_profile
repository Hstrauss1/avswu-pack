...
git config --global user.name "Hudson Strauss"
git config --global user.email "Hstrauss@scu.edu"
...
echo "------------------------------------------------------------------"
echo "STATUS: Setting up shell environment..."
echo "------------------------------------------------------------------"
...
export PATH=$PATH:/usr/local/go/bin:$HOME/.cargo/bin:$HOME/bin

# Start SSH service if not running
echo "------------------------------------------------------------------"
echo "STATUS: Ensuring SSH service is running..."
echo "------------------------------------------------------------------"
SSH_STATUS=$(service ssh status | grep running)
